  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.inputWrapper}>
        ...
        <TextInput style={styles.input} placeholder="Owner Full Name:" placeholderTextColor="#5B6E42" />
      </View>
      ...
      <View style={styles.inputWrapper}>
        ...
        <TextInput style={styles.input} placeholder="Owner Phone No:" placeholderTextColor="#5B6E42" keyboardType="phone-pad" />
      </View>
      ...
      <View style={styles.inputWrapper}>
        ...
        <TextInput style={styles.input} placeholder="Driving licence No:" placeholderTextColor="#5B6E42" />
      </View>

      {/* Profile Photo */}
      <TouchableOpacity style={styles.inputWrapper} activeOpacity={0.8}>
        <View style={styles.iconCircle}>
          <Image source={{ uri: 'https://img.icons8.com/ios-filled/50/compact-camera.png' }} style={styles.inputIcon} />
        </View>
